				...
				<table cellpadding='0' width='100%'
					...
					<tr>
						<td colspan='2' align='center'><table cellpadding='0'
								...
								<tr>
									<td class='td1'>常住户口所在地:</td>
									<td class='td2' align='Right'><gaLabel:label name="CZHKSZD" />
									</td>
									<td width='10%'>&nbsp;</td>
									<td class='td1'>实际居住地:</td>
									<td class='td2' align='Right'><gaLabel:label name="SJJZD" />
									</td>
								</tr>
								<tr>
