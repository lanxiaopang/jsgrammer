...
<div id="search_bar" class="grey_color1">
    <div class="g_bd1 f-cb">
        <div class="g_sd1">
            <div class="g_sd1c">
                <a href="search.html" target="_blank"><img src="<%=request.getContextPath()%>/images/result/list_logo.gif"></a>
            </div>
        </div>
        <div class="g_mn1">
            <div class="g_mn1c">
...
<div class="result_sum border_grey grey_color3">
    ...
    <a href="result_map.html" target="_self">
        <span id="display_mode3" class="display_mode12 white_bg_color">
            <img src="<%=request.getContextPath()%>/images/result/icon3_1.gif">
        </span>
    </a>
    <span class="separator grey_color4"></span>
    <a href="result_table.html" target="_self">
    ...
    <a href="result.html" target="_self">
        <span id="display_mode1" class="display_mode12 grey_color3">
            <img src="<%=request.getContextPath()%>/images/result/icon1_2.gif">
        </span>
    </a>
    <span class="separator grey_color4"></span>
...
<div id="result_map">
    <div id="map_con" class="border_grey"></div>

    <div id="scrollbar22">
        <div id="scrollbar22_inside">
            <div class="pic_con border_grey grey_color2">
                <div class="pic_top">
                    <div class="pic_top1">
                        <div class="pic_top_l">
                            <img src="<%=request.getContextPath()%>/images/map/tb_b_1.gif" style="margin: 0px;">
                            <span class="pic_name">张三</span>
                        </div>
                        <div class="pic_top_r">
                            <img src="<%=request.getContextPath()%>/images/result/touxiang.jpg"  style="margin:0px;">
                        </div>
                    </div>
                    <div class="pic_mid">
                        <a href="#" target="_blank"><img src="<%=request.getContextPath()%>/images/map/ryda.gif"></a>
                        <a href="#" target="_blank"><img src="<%=request.getContextPath()%>/images/map/mx.gif"></a>
                        <a href="#" target="_blank"><img src="<%=request.getContextPath()%>/images/map/fd.gif"></a>
                    </div>
                </div>

                <div class="pic_bot">
                    <div class="pic_bot_l">
                        <img src="<%=request.getContextPath()%>/images/map/home_1.gif" style="margin:0px;">
                    </div>
                    <div class="pic_bot_r">
                        郑路镇尚家庙村147号
                    </div>
            ...
            <div class="pic_con border_grey grey_color2">
                <div class="pic_top">
                    <div class="pic_top1">
                        <div class="pic_top_l">
                            <img src="<%=request.getContextPath()%>/images/map/tb_b_2.gif" style="margin: 0px;">
                            <span class="pic_name">张三</span>
                        </div>
                        <div class="pic_top_r">
                            <img src="<%=request.getContextPath()%>/images/result/touxiang.jpg"  style="margin:0px;">
            ...
            <div class="pic_con border_grey grey_color2">
                <div class="pic_top">
                    <div class="pic_top1">
                        <div class="pic_top_l">
                            <img src="<%=request.getContextPath()%>/images/map/tb_b_3.gif" style="margin: 0px;">
                            <span class="pic_name">张三</span>
                        </div>
                        <div class="pic_top_r">
                            <img src="<%=request.getContextPath()%>/images/result/touxiang.jpg"  style="margin:0px;">
            ...
            <div class="pic_con border_grey grey_color2">
                <div class="pic_top">
                    <div class="pic_top1">
                        <div class="pic_top_l">
                            <img src="<%=request.getContextPath()%>/images/map/tb_b_4.gif" style="margin: 0px;">
                            <span class="pic_name">张三</span>
                        </div>
                        <div class="pic_top_r">
                            <img src="<%=request.getContextPath()%>/images/result/touxiang.jpg"  style="margin:0px;">
            ...
            <div class="pic_con border_grey grey_color2">
                <div class="pic_top">
                    <div class="pic_top1">
                        <div class="pic_top_l">
                            <img src="<%=request.getContextPath()%>/images/map/tb_b_5.gif" style="margin: 0px;">
                            <span class="pic_name">张三</span>
                        </div>
                        <div class="pic_top_r">
                            <img src="<%=request.getContextPath()%>/images/result/touxiang.jpg"  style="margin:0px;">
            ...
            <div class="pic_con border_grey grey_color2">
                <div class="pic_top">
                    <div class="pic_top1">
                        <div class="pic_top_l">
                            <img src="<%=request.getContextPath()%>/images/map/tb_b_6.gif" style="margin: 0px;">
                            <span class="pic_name">张三</span>
                        </div>
                        <div class="pic_top_r">
                            <img src="<%=request.getContextPath()%>/images/result/touxiang.jpg"  style="margin:0px;">
            ...
            <div class="pic_con border_grey grey_color2">
                <div class="pic_top">
                    <div class="pic_top1">
                        <div class="pic_top_l">
                            <img src="<%=request.getContextPath()%>/images/map/tb_b_7.gif" style="margin: 0px;">
                            <span class="pic_name">张三</span>
                        </div>
                        <div class="pic_top_r">
                            <img src="<%=request.getContextPath()%>/images/result/touxiang.jpg"  style="margin:0px;">
            ...
            <div class="pic_con border_grey grey_color2">
                <div class="pic_top">
                    <div class="pic_top1">
                        <div class="pic_top_l">
                            <img src="<%=request.getContextPath()%>/images/map/tb_b_8.gif" style="margin: 0px;">
                            <span class="pic_name">张三</span>
                        </div>
                        <div class="pic_top_r">
                            <img src="<%=request.getContextPath()%>/images/result/touxiang.jpg"  style="margin:0px;">
            ...
            <div class="pic_con border_grey grey_color2">
                <div class="pic_top">
                    <div class="pic_top1">
                        <div class="pic_top_l">
                            <img src="<%=request.getContextPath()%>/images/map/tb_b_9.gif" style="margin: 0px;">
                            <span class="pic_name">张三</span>
                        </div>
                        <div class="pic_top_r">
                            <img src="<%=request.getContextPath()%>/images/result/touxiang.jpg"  style="margin:0px;">
            ...
            <div class="pic_con border_grey grey_color2">
                <div class="pic_top">
                    <div class="pic_top1">
                        <div class="pic_top_l">
                            <img src="<%=request.getContextPath()%>/images/map/tb_b_10.gif" style="margin: 0px;">
                            <span class="pic_name">张三</span>
                        </div>
                        <div class="pic_top_r">
                            <img src="<%=request.getContextPath()%>/images/result/touxiang.jpg"  style="margin:0px;">
...
<div id="result_pagination">
    <div id="pagination_con">
        ...
        <div class="page_general"><a href="#"><img src="<%=request.getContextPath()%>/images/result/tiaozhuan.gif"></a></div>
    </div>
</div>
</div>
...
<script src="<%=request.getContextPath()%>/jsp/js/jquery.tinyscrollbar.min.js"></script>
<script src="<%=request.getContextPath()%>/jsp/js/result_map.js"></script>
</body>
</html>