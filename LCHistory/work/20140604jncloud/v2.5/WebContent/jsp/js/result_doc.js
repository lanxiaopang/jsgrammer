...
function changeShowOrder(type,num){
    if(type=="order"){
        switch(num){
            case 2:
                var str2 = "<a href=\"#\" id=\"order_time\" onclick=\"return false;\"><img src="+ctx+"img\/doc\/sj.gif style=\"margin-top: 9px;\"><\/a>";
            ...
            case 1:
                ...
                document.getElementById('order_time').outerHTML=str2;
                var str = "<a href=\"#\" id=\"order_relate\" onclick=\"return false;\"><img src="+ctx+"img\/doc\/xgd.gif style=\"margin-top: 9px;\"><\/a>";
                document.getElementById('order_relate').outerHTML=str;
                break;
        }
    }else if(type=="search"){
        switch(num){
            case 2:
                var str2 = "<a href=\"#\" id=\"search_title\" onclick=\"return false;\"><img src="+ctx+"img\/doc\/bt.gif style=\"margin-top: 9px;\"><\/a>";
            ...
            case 1:
                ...
                document.getElementById('search_title').outerHTML=str2;
                var str = "<a href=\"#\" id=\"search_article\" onclick=\"return false;\"><img src="+ctx+"img\/doc\/qw.gif style=\"margin-top: 9px;\"><\/a>";
                document.getElementById('search_article').outerHTML=str;
                break;
        }
    }
