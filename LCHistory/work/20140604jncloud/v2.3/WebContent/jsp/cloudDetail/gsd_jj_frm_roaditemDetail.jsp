				...
				<table cellpadding='0' width='100%'
					...
					<tr>
						<td colspan='2' align='center'><table cellpadding='0'
								...
								<tr>
									<td class='td1'>记录状态:</td>
									<td class='td2' align='Right'><gaLabel:label name="JLZT" />
									</td>
									<td width='10%'>&nbsp;</td>
									<td class='td1'>起点名称:</td>
									<td class='td2' align='Right'><gaLabel:label name="QSMC" />
									</td>
								</tr>
								<tr>
									<td class='td1'>结束点名称:</td>
									<td class='td2' align='Right'><gaLabel:label name="JSMC" />
									</td>
									<td width='10%'>&nbsp;</td>
									<td class='td1'>行政区划详细里程:</td>
