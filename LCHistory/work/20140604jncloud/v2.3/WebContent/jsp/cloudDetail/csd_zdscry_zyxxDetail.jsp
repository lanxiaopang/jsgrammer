				...
				<table cellpadding='0' width='100%'
					...
					<tr>
						<td colspan='2' align='center'><table cellpadding='0'
								...
								<tr>
									<td class='td1'>住院日期:</td>
									<td class='td2' align='Right'><gaLabel:label name="ZYRQ" />
									</td>
									<td width='10%'>&nbsp;</td>
									<td class='td1'>出院日期:</td>
									<td class='td2' align='Right'><gaLabel:label name="CYRQ" />
									</td>
								</tr>
								<tr>
									<td class='td1'>金额:</td>
									<td class='td2' align='Right'><gaLabel:label name="SJFSFYZE" />
									</td>
								</tr>
