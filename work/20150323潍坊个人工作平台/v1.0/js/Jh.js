...
Jh.fn = function(me){//功能区
    return me = {
        ...
        _createLayoutTr:function(){//创建布局tr
            var _td = me._createTd(Jh.Config.tdCls2),
                _div = $("<div/>").addClass(Jh.Config.layCls)
                    ...
                    //.append(me._createA("50:77"))
                    .append("<a href='javascript:void(0);' class='active' rel='50:77'>\u9ED8\u8BA4</a>")
                    .append(me._createA("30:57:39"))
                    .appendTo(_td),
...
Jh.Portal = function(me){//Portal对象
    ...
    return me={
        ...
        _createItemContent:function(){//创建content
            ...
            $("<ul style='width:390px; height:150px;'><li>\u7A7A\u767D\u62D6\u62FD\u9875html580</li></ul>").appendTo(_content);
            return _content;
        },
