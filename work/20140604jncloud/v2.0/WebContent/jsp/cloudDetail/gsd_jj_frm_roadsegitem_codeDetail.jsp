				...
				<table cellpadding='0' width='100%'
					...
					<tr>
						<td colspan='2' align='center'><table cellpadding='0'
								...
								<tr>
									<td class='td1'>事故道路代码行政区划:</td>
									<td class='td2' align='Right'><gaLabel:label name="SGXZQH" />
									</td>
									<td width='10%'>&nbsp;</td>
									<td class='td1'>事故道路代码:</td>
									<td class='td2' align='Right'><gaLabel:label name="SGDLDM" />
									</td>
								</tr>
								<tr>
									<td class='td1'>事故路口路段:</td>
									<td class='td2' align='Right'><gaLabel:label name="SGLKLD" />
									</td>
									<td width='10%'>&nbsp;</td>
									<td class='td1'>违法管理部门:</td>
									<td class='td2' align='Right'><gaLabel:label name="WFGLBM" />
									</td>
								</tr>
								<tr>
									<td class='td1'>违法道路代码:</td>
									<td class='td2' align='Right'><gaLabel:label name="WFDLDM" />
									</td>
									<td width='10%'>&nbsp;</td>
									<td class='td1'>违法路口路段:</td>
									<td class='td2' align='Right'><gaLabel:label name="WFLKLD" />
									</td>
								</tr>
								<tr>
									<td class='td1'>传输标志:</td>
									<td class='td2' align='Right'><gaLabel:label name="CSBJ" />
									</td>
									<td width='10%'>&nbsp;</td>
