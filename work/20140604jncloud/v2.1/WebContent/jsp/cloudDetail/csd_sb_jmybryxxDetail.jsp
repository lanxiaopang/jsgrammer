				...
				<table cellpadding='0' width='100%'
					...
					<tr>
						<td colspan='2' align='center'><table cellpadding='0'
								...
								<tr>
									<td class='td1'>参保日期:</td>
									<td class='td2' align='Right'><gaLabel:label name="CBRQ" />
									</td>
									<td width='10%'>&nbsp;</td>
									<td class='td1'>人员类别:</td>
									<td class='td2' align='Right'><gaLabel:label name="RYLB" collection="DIC_JMYLRYLB"/>
									</td>
								</tr>
								<tr>
									<td class='td1'>参保状态:</td>
									<td class='td2' align='right'><gaLabel:label name="CBZT"
											collection="DIC_SBCBZT" />
									</td>
									<td width='10%'>&nbsp;</td>
									<td class='td1'>户口所在区:</td>
									<td class='td2' align='Right'><gaLabel:label name="HKSZQ" />
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td width='10%'>&nbsp;</td>
									<td class='td1'>亲属姓名:</td>
									<td class='td2' align='Right'><gaLabel:label name="QSXM" />
									</td>
								</tr>
								<tr>
									<td class='td1'>亲属关系:</td>
									<td class='td2' align='Right'><gaLabel:label name="QSGX" collection="DIC_JTGX" />
									</td>
									<td width='10%'>&nbsp;</td>
									<td class='td1'>亲属联系电话:</td>
									<td class='td2' align='Right'><gaLabel:label name="QSLXDH" />
									</td>
								</tr>
								<tr>
