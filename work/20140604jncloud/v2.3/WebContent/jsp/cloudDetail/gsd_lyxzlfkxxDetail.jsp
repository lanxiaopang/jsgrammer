					...
					<tr>
						<td colspan='2' align='center'><table cellpadding='0'
								...
								<tr>
									...
									<td class='td2' align='Right'><gaLabel:label name="PERSONALCARD"  />
									</td>
								</tr>
								<tr>
									<td class='td1'>性别:</td>
								...
								<tr>
									...
									<td class='td2' align='Right'><gaLabel:label name="BRITHDAY" />
									</td>
									<td width='10%'>&nbsp;</td>
									<td class='td1'>家庭住址:</td>
									<td class='td2' align='Right'><gaLabel:label name="ADDRESS" />
									</td>
								</tr>
								<tr>
									<td class='td1'>访客机标识:</td>
									<td class='td2' align='Right'><gaLabel:label name="FKJBS" />
									</td>
