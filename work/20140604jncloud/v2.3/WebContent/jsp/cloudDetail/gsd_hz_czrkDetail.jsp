				...
				<table cellpadding='0' width='100%'
					...
					<tr>
						<td colspan='2' align='center'><table cellpadding='0'
								...
								<tr>
									<td class='td1'>变动id:</td>
									<td class='td2' align='Right'><gaLabel:label name="BDID" />
									</td>
									<td width='10%'>&nbsp;</td>
								...
								<tr>
									...
									<td class='td2' align='right'><gaLabel:label name="YHZGX"
											collection="DIC_JTGX" />
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td width='10%'>&nbsp;</td>
									<td class='td1'>服务处所ID:</td>
									<td class='td2' align='Right'><gaLabel:label name="FWCSID" />
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td width='10%'>&nbsp;</td>
									<td class='td1'>视读照片:</td>
									<td class='td2' align='Right'><gaLabel:label name="SDZP" />
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class='td2' align='Right'><gaLabel:label name="YJGSSX" />
									</td>
									<td width='10%'>&nbsp;</td>
									</tr>
							</table>
