				...
				<table cellpadding='0' width='100%'
					...
					<tr>
						<td colspan='2' align='center'><table cellpadding='0'
								...
								<tr>
									<td class='td1'>入口站名称:</td>
									<td class='td2' align='Right'><gaLabel:label name="RKZMC" />
									</td>
									<td width='10%'>&nbsp;</td>
									<td class='td1'>入口时间:</td>
									<td class='td2' align='Right'><gaLabel:label name="RKSJ" />
									</td>
								</tr>
								<tr>
									<td class='td1'>入口车牌:</td>
									<td class='td2' align='Right'><gaLabel:label name="RKCP" />
									</td>
									<td width='10%'>&nbsp;</td>
									<td class='td1'>入口车型:</td>
									<td class='td2' align='Right'><gaLabel:label name="RKCX" />
									</td>
								</tr>
								<tr>
									<td class='td1'>出口站名称:</td>
									<td class='td2' align='Right'><gaLabel:label name="CKZMC" />
									</td>
									<td width='10%'>&nbsp;</td>
									<td class='td1'>出口口时间:</td>
									<td class='td2' align='Right'><gaLabel:label name="CKSJ" />
									</td>
								</tr>
								<tr>
									<td class='td1'>出口车牌:</td>
									<td class='td2' align='Right'><gaLabel:label name="CKCP" />
									</td>
									<td width='10%'>&nbsp;</td>
									<td class='td1'>出口车型:</td>
									<td class='td2' align='Right'><gaLabel:label name="CKCX" />
									</td>
								</tr>
