...
$(function(){
    ...
    $('.display_mode12').click(function(){
        ...
        if(flag==idx){
            ...
            $('.display_mode12').each(function(index,ele){
                b=3-index;
                $(this).find('img').attr('src',ctx+'img/result/icon'+b+'_2.gif');
            ...
            a=4-idx;
            $(this).find('img').first().attr('src',ctx+'img/result/icon'+a+'_1.gif');
    ...
    $('#img_more').toggle(
        function(){
            $(this).attr('src',ctx+'img/result/shouqi.gif');
            $('.g-mn5').css('height','auto');
            $('.g-mn5').css('overflow','auto');
        },
        function(){
            $(this).attr('src',ctx+'img/result/more.gif')
    ...
    $('.pic_con').hover(
        function(){
            ...
            $(this).find('.pic_bot_l').find('img').attr('src',ctx+'img/map/home_2.gif');
    ...
    function(){
        ...
        $(this).find('.pic_top_l').find('img').attr('src',foo);
        $(this).find('.pic_bot_l').find('img').attr('src',ctx+'img/map/home_1.gif');
...
function showHideTabBirth(){
    ...
    if($('.self_def').attr('src').indexOf('_2.gif')<0){
        $('.self_def').attr('src',ctx+'img/result/zidingyi_2.gif');
        $('.self_def').css('z-index','1001');
    }else{
        $('.self_def').attr('src',ctx+'img/result/zidingyi.gif');
