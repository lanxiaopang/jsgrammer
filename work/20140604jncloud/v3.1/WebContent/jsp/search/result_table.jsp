    ...
    <div id="selected_div_birth" class="border_top_dot p_relative">
        ...
        <span class="selected_txt">
            ...
            <span style="position: relative;">
                <img onclick="showHideTabBirth()" class="self_def" src="img/result/zidingyi.gif">
...
<div class="result_sum border_grey grey_color3">
    ...
    <a href="result_table.jsp" target="_self">
        <span id="display_mode2" class="display_mode12 white_bg_color">
            <img src="<%=request.getContextPath()%>/images/result/icon2_1.gif">
        </span>
    </a>
    <span class="separator grey_color4"></span>
...
<div id="result_table">
    ...
    <table class="table1">
        <thead class="grey_color3 border_left_grey border_right_grey" >
        <tr>
            <th style="width: 8%;">人员编号</th>
            <th style="width: 7%;">姓名</th>
            <th style="width: 6%;">曾用名</th>
            <th style="width: 5%;">性别</th>
            <th style="width: 15%;">身份证号</th>
            <th style="width: 5%;">民族</th>
            <th style="width: 6%;">职业</th>
            <th style="width: 8%;">出生日期</th>
            <th style="width: 17%;">住址</th>
            <th style="width: 16%;">工作单位</th>
...
<script src="<%=request.getContextPath()%>/jsp/js/tool.js"></script>
<script src="<%=request.getContextPath()%>/jsp/js/result_table.js"></script>
</body>
</html>